...
@Component
public class ListingEventJmsConsumer extends SpringRouteBuilder {
    private static Logger log = LoggerFactory.getLogger(ListingEventJmsConsumer.class);
