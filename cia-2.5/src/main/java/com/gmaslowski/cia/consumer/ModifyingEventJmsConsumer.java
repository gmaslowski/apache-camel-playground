...
@Component
public class ModifyingEventJmsConsumer extends SpringRouteBuilder {

    private static Logger log = LoggerFactory.getLogger(ModifyingEventJmsConsumer.class);
